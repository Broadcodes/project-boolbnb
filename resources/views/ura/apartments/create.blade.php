        ...
        <form action="{{ route('ura.apartments.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-3">
                ...
                <input type="text" class="form-control" name="apartment_title" id="apartment_title" required
                    maxlength="255" value="{{ old('apartment_title', '') }}">
            ...
            <div class="p-3">
                ...
                <textarea name="description" class="form-control" id="description" required minlength="5" cols="100"
            ...
            <div class="d-flex">
                ...
                {{-- provincia --}}
                <div class="p-3">
                    <label class="px-2 form-label" for="countrySubdivision">{{ __('Nazione') }}</label>
