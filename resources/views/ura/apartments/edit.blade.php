...
@section('content')
    <div class="py-4">
        <form action="{{ route('ura.apartments.update', $apartment->apartment_slug) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="p-3">
                ...
                <input type="text" name="apartment_title" id="apartment_title" value="{{ old('apartment_title', $apartment->apartment_title) }}">
            ...
            <div class="p-3">
                ...
                <input type="number" name="sqm" id="sqm" step=".01" value="{{ old('sqm', $apartment->sqm) }}">
                @error('sqm')
                    <h5 class="text-danger ml-4">{{ $message }}</h5>
                @enderror
            </div>
            ...
            <div class="p-3">
                ...
                <input type="number" name="price" id="price" step=".01" value="{{ old('price', $apartment->price) }}">
                @error('price')
                    <h5 class="text-danger ml-4">{{ $message }}</h5>
                @enderror
            </div>
            ...
            <div class="p-3">
                ...
                <input type="number" name="civic_number" id="civic_number" value="{{ old('civic_number', $apartment->civic_number) }}">
                @error('civic_number')
                    <h5 class="text-danger ml-4">{{ $message }}</h5>
                @enderror
            </div>
            <div class="p-3">
                ...
                <input type="text" name="postalCode" id="postalCode" maxlength='5' value="{{ old('postalCode', $apartment->postalCode) }}">
                @error('postalCode')
                    <h5 class="text-danger ml-4">{{ $message }}</h5>
                @enderror
            </div>
