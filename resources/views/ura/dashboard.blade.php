...
@section('content')
    <div id="dashboard">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="nc-accountInfo d-flex align-items-center">
                        <div class="nc-card d-flex flex-column align-items-center">
                            <img class="img-fluid nc-profilePic mt-3" src="{{ url('/images/profile-pic.png') }}"
                                alt="profile pic">
                        ...
                        <div class="nc-userAction d-flex justify-content-start">
                            <div>
                                <p>
